...
class Controller_authorif extends Controller
{
    ...
    public function action_check_pass()
    {
        ...
        if (isset($_POST['Enter'])) {
            ...
            if (count($err) > 0) {
                ...
                if (!empty ($salt)) {
                    ...
                    $idArr = $this->model->check_login_pass($login, $password);
                    $id = $idArr[0]['id'];
                }
        ...
        if (isset($_POST['Registration'])) {
            ...
            if (isset($_POST['mail']) && empty($_POST['password'])) {
            ...
            if (count($err) > 0) {
                ...
                if (count($err) > 0) {
                    ...
                    if (empty($id)) {
                        ...
                        $this->model->create_login_pass_salt_email($login, $password, $salt, $mail, $user_ip);
...
public
function authorif_send_letter($adress, $login)
{
